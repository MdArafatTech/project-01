...
const Account = () => {
  const { currentUser, logout, updateProfile, sendEmailVerification } =
    useAuth();
  ...
  const detectDeviceInfo = () => {
    ...
    if (/android/i.test(ua)) {
      if (/samsung/i.test(ua)) {
        brand = "Samsung";
        model =
          ua.match(/sm-[a-z0-9]+/i)?.[0]?.toUpperCase() || "Galaxy Series";
                ...
                <div className="flex flex-col md:flex-row items-center gap-4">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="space-y-2">
                      <p>
                        <strong>Name:</strong> {profileForm.displayName}
                      </p>
                      <p>
                        <strong>Phone:</strong>{" "}
                        {profileForm.phoneNumber || "N/A"}
                      </p>
                      <p>
